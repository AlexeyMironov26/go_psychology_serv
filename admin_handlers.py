...
class AdminHandler:
    ...
    async def _show_eysenck_averages(self, query, faculty_name=None):
        ...
        text += "• 23–24: Невротизм, граничащий с патологией\n"
        text += "• 17–23: Присутствуют отдельные признаки расшатанности нервной системы\n"
        text += "• 11-16: Эмоциональная впечатлительность\n"
        text += "• 0–10: Эмоциональная устойчивость\n\n"
        if n >= 23:
